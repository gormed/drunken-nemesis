...
public class Heading extends BitmapText {
    ...
    public Heading(boolean rightToLeft, boolean arrayBased) {
        super(OpusApplication.getInstance().getAssetManager().loadFont("Interface/Fonts/Avenir16.fnt"), rightToLeft, arrayBased);
    }

    public Heading( boolean rightToLeft) {
        super(OpusApplication.getInstance().getAssetManager().loadFont("Interface/Fonts/Avenir16.fnt"), rightToLeft);
    }
