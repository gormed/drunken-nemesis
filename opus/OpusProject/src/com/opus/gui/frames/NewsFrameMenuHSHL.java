 ...
 * @author Senju
 */
public class NewsFrameMenuHSHL extends AbstractFrameMenu {
    private final Card card;
    private Circle background;
    private final int DIAMETER = 300;

    public NewsFrameMenuHSHL(AbstractUserFrame frame) {
        super(frame);
    ...
    public void createMenu() {
        ...
        addMenuEntry(new AbstractFrameMenuEntry(this) {
            ...
            protected void createEntry() {
                createRotated(this, (float) (0.5f * Math.PI), "HSHL News");
            }
        });
